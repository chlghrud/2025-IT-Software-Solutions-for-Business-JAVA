...
public class BF extends JFrame {
	...
	public void addEmptyPanel(JPanel jp, JScrollPane s, int max, int cnt) {
		if(cnt >= max) {
	...
	public void openForm(JFrame bf, JFrame af) {
		bf.setVisible(false);
		af.setVisible(true);
		forms.push(bf);
