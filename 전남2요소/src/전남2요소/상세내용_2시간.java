...
public class »ó¼¼³»¿ë_2½Ã°£ extends JFrame {
	...
	public »ó¼¼³»¿ë_2½Ã°£() {
		...
		label_1.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		...
		label_2.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		...
		label_3.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		...
		label_5.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		...
		label_7.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		...
		label_8.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		...
		label_6.setFont(new Font("¸¼Àº °íµñ", Font.BOLD, 17));
		label_6.setBounds(55, 33, 93, 89);
		panel.add(label_6);
		setTimer(LocalDateTime.of(LocalDate.of(2025, 7, 10), LocalTime.of(12, 00)));
	}
	...
	private void setTimer(LocalDateTime end) {
		...
		new Timer(1000, new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Duration duration = Duration.between(no, end);
				...
				l[0].setText(days + "ÀÏ");
				l[1].setText((hours / 10) + ""); 
				l[2].setText((hours % 10)+ ""); 
				l[3].setText((minutes / 10)+ ""); 
				l[4].setText((minutes % 10)+ ""); 
				l[5].setText((seconds / 10)+ ""); 
				l[6].setText((seconds % 10)+ ""); 
			}
		}).start();
	}
}
